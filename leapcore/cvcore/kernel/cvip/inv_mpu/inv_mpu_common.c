...
extern uint64_t gsm_jrtc_get_time_ns(void);
...
s64 get_time_ns(void)
{
#ifdef SUPPORT_JRTC_MODE
	// use JRTC clock instead of cvip linux kernel clock
	return gsm_jrtc_get_time_ns();
#else
...
#endif
#endif // for #ifdef SUPPORT_JRTC_MODE
}
#endif

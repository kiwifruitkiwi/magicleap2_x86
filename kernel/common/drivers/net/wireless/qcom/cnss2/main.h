...
#define BHI_WLFW_MAX_NUM_MEM_SEG_V01 16
...
static inline int cnss_get_vreg_type(struct cnss_plat_data *plat_priv,
				     enum cnss_vreg_type type)
{
	return 0;
}

static inline void cnss_put_vreg_type(struct cnss_plat_data *plat_priv,
				      enum cnss_vreg_type type)
{
}

static inline int cnss_vreg_on_type(struct cnss_plat_data *plat_priv,
				    enum cnss_vreg_type type)
{
	return 0;
}

static inline int cnss_vreg_off_type(struct cnss_plat_data *plat_priv,
				     enum cnss_vreg_type type)
{
	return 0;
}

static inline int cnss_get_clk(struct cnss_plat_data *plat_priv)
{
	return 0;
}

static inline void cnss_put_clk(struct cnss_plat_data *plat_priv)
{
}

static inline int cnss_vreg_unvote_type(struct cnss_plat_data *plat_priv,
					enum cnss_vreg_type type)
{
	return 0;
}

static inline int cnss_get_pinctrl(struct cnss_plat_data *plat_priv)
{
	return 0;
}
#endif /* CONFIG_X86 */

 ...
 *
 * $Id: wlioctl.h 785346 2018-10-18 04:18:38Z $
 */
...
/* Deprecated - To be removed */
#define WL_TWT_FLOW_FLAG_BROADCAST	(1u << 6u)
#define WL_TWT_FLOW_FLAG_WAKE_TBTT_NEGO (1u << 7u)
#define WL_TWT_FLOW_FLAG_IMPLICIT	(1u << 8u)

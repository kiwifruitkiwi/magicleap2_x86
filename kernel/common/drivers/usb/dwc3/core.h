 ...
 * @prev_dr_role: previous role of operation when in dual-role mode before going to suspend
 * @edev: extcon handle
...
#define DWC31_VERSIONTYPE_EA06		0x65613036
	...
	unsigned		use_sw_node_quirk:1;

	unsigned		snps_broken_suspend:1; /*quirk for SNPS HCE and SRE Bits error issue */
	unsigned		snps_force_hostmode_suspend:1; /*quirk for SNPS to force  Host mode before S3*/

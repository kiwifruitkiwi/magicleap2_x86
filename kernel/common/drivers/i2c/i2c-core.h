...
int i2c_acpi_get_highest_bus(void);
...
static inline int i2c_acpi_get_highest_bus(void) { return -ENOSYS; }
static inline int i2c_acpi_get_first_dyn_bus(void) { return -ENOSYS; }
#endif /* CONFIG_ACPI */

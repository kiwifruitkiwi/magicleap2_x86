...
#define AE_ALGO_TUNING_VER 3001201119U
...
struct _ae_smooth_cfg_str {
	...
	int inStableThd;
	int outStableThd;
	int oneShotPerframeRatioD2tOutdoor;
	int oneShotPerframeRatioD2t;
	int oneShotPerframeRatioB2tOutdoor;
	int oneShotPerframeRatioB2t;
	float deltaEvRounding;

	int initIndex;
	int initEv;
	int initIndexSe;
	int initEvSe;
	int faceRectRndXYPcnt;
	int faceRectRndSZPcnt;
	int faceRectOverlapPcnt;
	int faceRectInThdPcnt;
	int faceRectOutThdPcnt;
	int faceRectSmoothLevel;
	int faceRectBufLen;
	int faceRectLostMaxCnt;

	int facePerameRatioD2tX[2];
	int facePerameRatioD2tY[2];
	int facePerameRatioB2tX[2];
	int facePerameRatioB2tY[2];
	int faceNonLinearCwvRatioX[2];
	int faceNonLinearCwvRatioY[2];
	int faceNonLinearAvgRatioX[2];
	int faceNonLinearAvgRatioY[2];
	int faceTrackingLockMaxCnt;
	int faceTrackingLockYLowBnd;
	int faceTrackingLockYHighBnd;
	int faceLostLockMaxCnt;
	int faceLostLockYLowBnd;
	int faceLostLockYHighBnd;
	int faceHugeYDiffThd;
	int faceHugeYDiffMaxCnt;
	int faceReConvgWhenAfDone;
	int faceReConvgWhenFaceChange;
	int faceReConvgWhenLvChange;
	int faceReConvgLvThreshold;
	int faceReConvgWhenSizeChange;
	int faceReconvgSizeThreshold;
	int faceInStableThd;
	int faceOutStableThd;
	int faceInToOutMaxCnt;

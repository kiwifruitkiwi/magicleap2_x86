 ...
 *SOURCE
 */
int dw_i2c_set_target_address(struct dw_device *dev, unsigned short address);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_set_slave_address(struct dw_device *dev, unsigned short address);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_set_master_code(struct dw_device *dev, unsigned char code);
/*****/
...
int dw_i2c_set_scl_count(struct dw_device *dev, enum dw_i2c_speed_mode
		mode, enum dw_i2c_scl_phase phase, unsigned short value);
/*****/
 ...
 *SOURCE
 */
void dw_i2c_write(struct dw_device *dev, unsigned short datum);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_set_tx_threshold(struct dw_device *dev, unsigned char level);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_set_rx_threshold(struct dw_device *dev, unsigned char level);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_master_transmit(struct dw_device *dev, unsigned char *buffer,
 ...
 *SOURCE
 */
int dw_i2c_slave_transmit(struct dw_device *dev, unsigned char *buffer,
			unsigned int length, dw_callback callback);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_slave_bulk_transmit(struct dw_device *dev, unsigned char *buffer,
			unsigned int length, dw_callback callback);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_master_receive(struct dw_device *dev, unsigned char *buffer,
			unsigned int length, dw_callback callback);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_slave_receive(struct dw_device *dev, unsigned char *buffer, unsigned
 ...
 *SOURCE
 */
int dw_i2c_set_dma_tx_level(struct dw_device *dev, unsigned char level);
/*****/
 ...
 *SOURCE
 */
int dw_i2c_set_dma_rx_level(struct dw_device *dev, unsigned char level);
/*****/

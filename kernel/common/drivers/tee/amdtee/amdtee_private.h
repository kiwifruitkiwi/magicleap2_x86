...
#define MAX_ALLOWED_DLM_BUFFERS		16
...
struct amdtee_context_data {
	...
	/* Debug Log Messages Service Manager */
	struct dlm_manager dlm_manager[MAX_ALLOWED_DLM_BUFFERS];
};
...
void *get_shm_kaddr(u32 buf_id);

/*
 * Functions for handling DLM (Debug Log Message) service related
 * commands
 */

...
struct tee_driver_ops {
	...
	int (*get_debug_token)(struct tee_context *ctx,
			struct tee_ioctl_get_debug_token_data *get_token);
	int (*start_ta_debug)(struct tee_context *ctx,
			struct tee_ioctl_start_ta_debug_data *arg);
	int (*fetch_debug_strings)(struct tee_context *ctx,
			struct tee_ioctl_fetch_debug_strings_data *arg);
	int (*stop_ta_debug)(struct tee_context *ctx,

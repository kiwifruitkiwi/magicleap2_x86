...
/*
 * struct iommu_fault_info - iommu_fault_info contains information need to
 *                           be transferred to iommu client.
 * @iova: io virtual address
 * @pte: page table entry
 * @dev: physical address
 */
...
int iommu_fwspec_get_id_nolock(struct device *dev, u32 *id, u32 index);
const struct iommu_ops *iommu_ops_from_fwnode(struct fwnode_handle *fwnode);
int iommu_set_sid_nolock(struct device *dev, u32 id, u32 index);
...
static inline int iommu_fwspec_get_id_nolock(struct device *dev, u32 *id,
					     u32 index)
{
	return -ENODEV;
}

static inline int iommu_set_sid_nolock(struct device *dev, u32 id, u32 index)
{
	return -ENODEV;
}

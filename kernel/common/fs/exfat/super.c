...
static const struct fs_parameter_spec exfat_parameters[] = {
	...
	__fsparam(0, "utf8",			Opt_utf8, fs_param_deprecated),
	__fsparam(0, "debug",		Opt_debug, fs_param_deprecated),
...
const struct fs_parameter_description exfat_fs_parameters = {
	.name		= "exfat",
	.specs		= exfat_parameters,
...
static int exfat_parse_param(struct fs_context *fc, struct fs_parameter *param)
{
	...
	opt = fs_parse(fc, &exfat_fs_parameters, param, &result);
	if (opt < 0)
		return opt;
...
static struct file_system_type exfat_fs_type = {
	...
	.parameters		= &exfat_fs_parameters,

...
#define FIRMWARE_ACP5x "ml_acp5x_fwimage_5_0.sbin"
#define FIRMWARE_ACP5x_UNSIGNED "ml_acp5x_fwimage_5_0.bin"
#define FIRMWARE_ACP5x_DATA_BIN "ml_acp5x_fwdata_5_0.bin"

#define ACP_ERROR_MASK                                0x20000000
#define ACP_DMA_MASK                                  0x01 /* ML: was 0xFF */
...
/* Amount of data that will be transferred for each TX DMA data payload */
#define ACP_DMA_BUFFER_TX_SIZE      0x10000
/* Number of pages for each TX DMA data payload */
#define ACP_DMA_BUFFER_TX_PAGE_COUNT 0x10

/* Amount of data that will be transferred for each RX DMA data payload */
#define ACP_DMA_BUFFER_RX_SIZE      0x10000
/* Number of pages for each RX DMA data payload */
#define ACP_DMA_BUFFER_RX_PAGE_COUNT 0x10
 ...
 * acp_dma_virt_rx_addr - acp dma RX buffer virtual address
 * acp_dma_rx_addr - acp dma RX buffer physical address
...
struct acp5x_dev_data {
	...
	dma_addr_t acp_dma_rx_addr;
	void *acp_dma_virt_rx_addr;

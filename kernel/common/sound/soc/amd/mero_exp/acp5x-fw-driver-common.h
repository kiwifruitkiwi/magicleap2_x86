...
struct acpev_cmd_set_power_mode {
	unsigned int cmd_number;
};
...
enum acpev_cmd {
	...
	ACP_EV_CMD_ML_START_DMA_FRM_SYS_MEM = 0x115,
	ACP_EV_CMD_ML_STOP_DMA_FRM_SYS_MEM,
	ACP_EV_CMD_ML_START_DMA_TO_SYS_MEM,
	ACP_EV_CMD_ML_STOP_DMA_TO_SYS_MEM,
	ACP_EV_CMD_ML_DSP_LOOPBACK,
	ACP_EV_CMD_ML_SET_POWER_MODE_SUSPEND,
	ACP_EV_CMD_ML_SET_POWER_MODE_RESUME
};
